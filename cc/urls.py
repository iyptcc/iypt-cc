...
def handler404(request, *args, **kwargs):
    context = {"request": request, "exception": kwargs.get("exception")}
...
urlpatterns = [
    ...
    re_path(
        r"^registration/", include("apps.registration.urls", namespace="registration")
    ),
    ...
    re_path(
        r"^oauth/", include("apps.account.oauth.urls", namespace="oauth2_provider")
    ),
