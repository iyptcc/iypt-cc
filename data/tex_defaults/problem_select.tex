...
(% block content %)
	...
	(% for team in teams -%)
		\begin{center}
    {\boldfont 37\textsuperscript{th} International Young Physicists’ Tournament\medskip
...
{\footnotesize
{\blackfont IYPT-Regulations section IX/2 (Version 2022):}
...
Problems of the 37\textsuperscript{th} IYPT:
 \begin{multicols}{3}
	(% for p in problems %)
    	(( p[0] )). (( p[1] ))
    (% endfor %)
