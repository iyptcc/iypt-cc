...
def show(request, id):
    ...
    return render(request,"schedule/show.html",context={"schedule":st,"meet":meet,
...
class GenerateView(View):
    ...
    def post(self, request):
        ...
        if form.is_valid():
            ...
            return render(request,"schedule/showgen.html",context={"schedule":plan, "roomnames":roomnames,
                                                               "meet":meet,
                                                               "meet_ratio": 100.0 / (len(meet[0]) + 1),
                                                               "team_rooms": team_rooms,
                                                               "equal_room": equal_rows,
