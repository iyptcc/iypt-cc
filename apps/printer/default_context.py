...
for typ, name in Template.TYPE:
    try:
        with open(
            os.path.join(
                settings.BASE_DIR, "apps", "printer", "contexts", "%s.json" % typ
            )
        ) as f:
            default_template_context[typ] = json.load(f)
    except:
        pass

default_template_context.update(
    {
        Template.PREVIEW: {
            "fight_id": 3324,
            "round": 2,
            ...
            "stages": [
                {
                    "order": 1,
                    "reporter_team": "USA",
                    "reporter_person_first_name": "Christoper",
                    "reporter_person_last_name": "Springfield",
                    "opponent_team": "China",
                    "opponent_person_first_name": "Chris",
                    "opponent_person_last_name": "Field",
                    "reviewer_team": "Iran",
                    "reviewer_person_first_name": "Chi",
                    "reviewer_person_last_name": "Lu",
                ...
                },
                {
                    "order": 4,
                    "reporter_team": "USA",
                    "reporter_person_first_name": "Hallo",
                    "reporter_person_last_name": "Bla",
                    "opponent_team": "China",
                    "opponent_person_first_name": "Chris",
                    "opponent_person_last_name": "Field",
                    "reviewer_team": "Iran",
            ...
            "fights": [
                ...
                },
                {
                    ...
                    "jurors": [
                        ("Yury", "Bashkatov"),
                        ("Iat Neng", "Chan"),
                        ("Tatyana", "Gonçalves Stankevicius"),
                        ("Leong", "Tze Kwang"),
                    ],
